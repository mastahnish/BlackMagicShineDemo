package com.overplay.blackmagicshinedemo.constants
...
class Constants {
    companion object {
        ...
        const val GEOFENCE_EXPIRATION_IN_MILLISECONDS = 5000L
        const val VIDEO_START = 0L
        const val TWO_SECONDS_MILLIS = 2000L
        const val LOCATION_REQUEST_INTERVAL = 1000L
        const val LOCATION_REQUEST_FASTEST_INTERVAL = 500L
        const val LOCATION_REQUEST_MAX_WAIT_TIME = 2000L
    }
}